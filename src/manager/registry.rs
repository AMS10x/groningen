...
pub fn bundled_extensions() -> Vec<ExtensionManifest> {
    vec![
        ...
        ExtensionManifest {
            language_pair: "en-es".to_string(),
            display_name: "English → Spanish (mock)".to_string(),
            url: "https://example.com/groningen/models/en-es.bin".to_string(),
            checksum: None,
            size_bytes: Some(1_048_576),
        },
        ExtensionManifest {
            language_pair: "en-de".to_string(),
            display_name: "English → German (mock)".to_string(),
            url: "https://example.com/groningen/models/en-de.bin".to_string(),
            checksum: None,
            size_bytes: Some(1_048_576),
        },
    ]
